...
import { PlusOutlined,VideoCameraAddOutlined, PlayCircleOutlined } from "@ant-design/icons";
import { Form, Input, Rate, DatePicker, Switch, Upload, Tag } from "antd";
...
class MyComponent extends Component {
  ...
  layDuLieu = () => {
    ...
    this.props.dispatch(
      quanTriPhimAction.Creators.getSaga({
  ...
  xoaNguoiDung = (maPhim) => {
    this.props.dispatch(
      otherFunctionAction.Creators.xoaPhim(maPhim, () => {
        this.layDuLieu;
      })
    );
  };
  themThongTin = (values) => {
    ...
    this.props.dispatch(
      otherFunctionAction.Creators.themPhim(formData, this.layDuLieu())
    );
  };
  suaThongTin = (values) => {
    const formData = new FormData();
    ...
    this.props.dispatch(
      otherFunctionAction.Creators.capNhatPhim(formData,this.layDuLieu())
    );
  };
  handleTrailer = (src) => {
